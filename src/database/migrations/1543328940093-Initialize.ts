...
export class Initialize1543328940093 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE "user_current_watch_to_game_watchers" ("gameId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_e2a34dee8495ffc770de0411de9" PRIMARY KEY ("gameId", "userId"))`);
    ...
    await queryRunner.query(`ALTER TABLE "user_current_watch_to_game_watchers" ADD CONSTRAINT "FK_e5433b1d01c65d0f872300510f0" FOREIGN KEY ("gameId") REFERENCES "game"("id") ON DELETE CASCADE`);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`ALTER TABLE "user_current_watch_to_game_watchers" DROP CONSTRAINT "FK_e5433b1d01c65d0f872300510f0"`);
