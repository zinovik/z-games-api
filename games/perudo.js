    ...
    move(move) {
        ...
        if (move.notBelieve) {
            ...
            if (countDiceNumber < this._currentDiceNumber) {
                let fine = Math.min(this._currentDiceNumber - countDiceNumber, this._players[this._lastPlayerNumber].dicesCount);
                ...
                let fine = Math.min(Math.max(countDiceNumber - this._currentDiceNumber, 1), this._players[this._nextPlayerNumber].dicesCount);
